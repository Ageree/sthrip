...
from stealthpay.swaps.coordinator import SwapFactory
from stealthpay.swaps.btc.rpc_client import BitcoinRPCClient
...
```bash
cd /Users/saveliy/Documents/Agent Payments/stealthpay
